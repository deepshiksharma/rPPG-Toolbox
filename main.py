...
def add_args(parser):
    ...
    parser.add_argument('--config_file', required=False,
                        default="UBFC-rPPG_PHYSNET.yaml", type=str, help="The name of the model.")
...
if __name__ == "__main__":
    ...
    if config.TOOLBOX_MODE == "train_and_test":
        ...
        elif config.TRAIN.DATA.DATASET == "rPPGrPPGrPPG":
            train_loader = data_loader.rPPGrPPGrPPGLoader.rPPGrPPGrPPGLoader
        else:
        ...
        elif config.VALID.DATA.DATASET == "rPPGrPPGrPPG":
            valid_loader = data_loader.rPPGrPPGrPPGLoader.rPPGrPPGrPPGLoader
    ...
    if config.TOOLBOX_MODE == "train_and_test" or config.TOOLBOX_MODE == "only_test":
        ...
        elif config.TEST.DATA.DATASET == "rPPGrPPGrPPG":
            test_loader = data_loader.rPPGrPPGrPPGLoader.rPPGrPPGrPPGLoader
        else:
            raise ValueError("Unsupported dataset! Currently supporting UBFC-rPPG, PURE, MMPD, \
                             SCAMPS, BP4D+ (Normal and BigSmall preprocessing), UBFC-PHYS and iBVP.")
